...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@glidepath/ui/components/sheet";
import { Skeleton } from "@glidepath/ui/components/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@glidepath/ui/components/tooltip";
import { useIsMobile } from "@glidepath/ui/hooks/use-mobile";
...
// The upstream block keeps this state in a cookie so a server can read it
// during render. This app is a single-page app, so local storage is enough.
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // This keeps the sidebar state between visits.
